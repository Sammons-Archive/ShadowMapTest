...
public class FloorEntityBuilder implements GenericBuilderImpl {

    private Quad quadGeo;
    private RenderComponent orthoRC;
    private static Entity floor = new Entity("floor");

    public FloorEntityBuilder() {
    }
    ...
    public void createFloor(WorldManager worldManager, ShadowMapRenderBuffer shadow) {
        ...
        floor.addComponent(RenderComponent.class, orthoRC);
        worldManager.addEntity(floor);
    }
